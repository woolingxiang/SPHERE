...
devtools::install_github('woolingxiang/SPHERE')
```
#### option 2
```{r}
install.packages('renv') # version ≥ 1.0.5
renv::init('.')
renv::install('woolingxiang/SPHERE')
